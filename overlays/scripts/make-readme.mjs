...
const PURPOSE = {
  ...
  RC_DEMO_TILING: 'Three A4 pages tile left to right onto the bleed line.',
  RC_DEMO_BULLSEYE: 'The second page slides until its darts land on the first.',
  RC_DEMO_TESTSQUARE: 'Page one prints; the square measures two inches.',
